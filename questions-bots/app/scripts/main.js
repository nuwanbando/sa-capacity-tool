...
$(document).ready(function() {
  loadResources().then(function() {
    ...
    $( "#questions form" ).change(function() {
      ...
      var image_tag = '<img width="600px" src="'+weightDescription.img+'" alt="'+weightDescription.description+'"/>';
      for (var i = 0; i < oGrade.length; i++) {
         image_tag += '<img width="200px" src="'+weightDescription.children[oGrade[i]].img
+'" alt="'+weightDescription.children[oGrade[i]].description+'"/>';
      }
